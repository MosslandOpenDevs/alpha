 ...
 * - 분 500 호출 (Demo key)
 *
 * This file is now only the HTTP client. Which entity maps to which
 * instrument, and whether that instrument can carry a call, moved to
 * lib/prices.ts — those questions have two answers now (coins and Yahoo
 * symbols) and neither belongs to one vendor's client.
 */
